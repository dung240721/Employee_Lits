...
public class StudentServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        studentList.add(new Student(1, "Han Nguyen Minh Anh", "T2108A1", 9.9));
        studentList.add(new Student(2, "Ho Anh Dung", "T2108A1", 5.9));
        studentList.add(new Student(3, "Minh Anh", "T2108A1", 8.0));
        studentList.add(new Student(4, "Nguyen Manh Dung", "T2108A1", 10));
    }
